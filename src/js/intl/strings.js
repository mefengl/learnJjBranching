exports.strings = {
  ...
  "git-warning-hard": {
    "__desc__": "One of the warning messages for git",
    "en_US": "The default behavior for resets on LearnJjBranching is a --hard, so feel free to omit that option if you get tired of typing it out in our lessons. Just remember that the default behavior on actual Git is --mixed.",
    ...
    "uk": "На LearnJjBranching reset по замовчуванню використовує --hard, тому цю опцію можна пропустити, якщо ти втомився її набирати щоразу. Тільки запам’ятай, що по замовчуванню звичайний git reset використовує --mixed",
    "ko": "LearnJjBranching에서 reset의 기본 설정은 --hard이므로, 이 옵션을 입력하는 것이 번거롭게 느껴진다면 생략해도 됩니다. 다만 실제 Git의 기본 설정 옵션은 --mixed라는것만 기억하세요.",
    "vi": "Trạng thái mặc định cho lệnh `reset` của \"Học nhánh jj\" là `--hard`. Nên khi làm bài nếu bạn thấy gõ tham số này hơi tốn công thì cứ bỏ qua. Nhưng mà hãy nhớ rằng thực tế thì `--mixed` mới là trạng thái mặc định của `reset`.",
    "sl_SI": "Privzeto delovanje za reset na LearnJjBranching je --hard, zato lahko to izpustiš. Na pravem gitu je --mixed.",
    "pl": "Domyślnym zachowaniem dla polecenia `reset` w LearnJjBranching jest parametr --hard, więc możesz pominąć tę opcję, Pamiętaj tylko, że domyślne zachowanie rzeczywistego GIT-a jest parametr --mixed.",
    "it_IT": "Il comportamento base per i resets su LearnJjBranching è --hard, per cui puoi tranquillamente omettere quella opzione se ti sei stancato di scriverla. Ricorda però che in Git, l'opzione di default è --mixed.",
    "ta_IN": "The default behavior for resets on LearnJjBranching is a --hard, so feel free to omit that option if you get tired of typing it out in our lessons. Just remember that the default behavior on actual Git is --mixed.",
    "tr_TR": "LearnJjBranching deki sıfırlama işlemlerinin varsayılan davranışı --hard tır, bu yüzden derslerimizde yazarken bundan sıkılırsanız bu seçeneği atlayabilirsiniz. Ancak gerçek Git teki varsayılan davranışın --mixed olduğunu unutmayın."
  },
  "git-error-staging": {
    "__desc__": "One of the error messages for git",
  ...
  "learn-git-branching": {
    ...
    "zh_CN": "学习 jj 分支",
    "zh_TW": "學習 jj 分支",
    "es_AR": "Aprendé a Branchear en jj",
    "es_MX": "Aprende jj Branching",
    "es_ES": "Aprende jj Branching",
    "pt_BR": "Aprenda jj Branching",
    "gl": "Aprende jj Branching",
    "fr_FR": "Apprenez jj Branching",
    "ro": "Învață ramificarea jj",
    "ru_RU": "Изучаем ветвление в jj",
    "uk": "Вивчай jj Branching",
    "ko": "jj 브랜칭을 배우기",
    "vi": "Học nhánh jj",
    "sl_SI": "Nauči se jj Branching",
    "pl": "Naucz się jj Branching-u",
    "it_IT": "Impara jj Branching",
    "ta_IN": "jj கிளை அமைத்தல்",
    "tr_TR": "Learn jj Branching"
  },
  "select-a-level": {
  ...
  "git-version": {
    ...
    "en_US": "jj Version 0.1.0",
    "de_DE": "jj Version 0.1.0",
    "zh_CN": "jj 版本 0.1.0",
    "zh_TW": "jj 版本 0.1.0",
    "es_AR": "jj Versión 0.1.0",
    "es_MX": "jj Versión 0.1.0",
    "es_ES": "jj Versión 0.1.0",
    "pt_BR": "jj versão 0.1.0",
    "gl": "jj versión 0.1.0",
    "fr_FR": "jj version 0.1.0",
    "ro": "Versiunea jj 0.1.0",
    "ru_RU": "Версия jj 0.1.0",
    "uk": "Версія jj 0.1.0",
    "ko": "jj Version 0.1.0",
    "vi": "Phiên bản jj 0.1.0",
    "sl_SI": "jj Verzija 0.1.0",
    "pl": "Wersja jj 0.1.0",
    "it_IT": "jj Version 0.1.0",
    "ta_IN": "jj Version 0.1.0",
    "tr_TR": "jj versiyonu 0.1.0"
  },
  "flip-tree-command": {
  ...
  "mobile-alert": {
    ...
    "pl": "Przepraszamy, ale LearnJjBranching nie obsługuje wpisywania komend z urządzeń mobilnych. Odwiedź LearnJjBranching na komputerze stacjonarnym, warto! :D",
  ...
  "command-disabled": {
    ...
    "ko": "그 jj 명령어는 이 레벨에서 사용할 수 없습니다.",
  ...
  "help-vague-level": {
    ...
    "en_US": "You are in a level, so multiple forms of help are available. Please select either \"help level\" to learn more about this lesson, \"help general\" for using Learn jj Branching, or \"objective\" to learn about how to solve the level.",
    "de_DE": "Du befindest dich in einem Level, daher gibt es verschiedene Hilfen. Gib \"help level\" ein um mehr über dieses Level zu erfahren, \"help general\" um zu sehen wie Learn jj Branching bedient wird, oder \"objective\" um das Ziel dieses Levels zu erfahren.",
    "zh_CN": "您正在关卡中，这里有多种形式的帮助，请选择 \"help level\" (关卡帮助)或 \"help general\" (一般帮助)",
    "zh_TW": "您正在進行關卡中，這裡有多種不同型式的幫助，請選擇 \"help level\" 來了解這個關卡，或者是選擇 \"help general\" 來學習如何使用 Learn jj Branching，或者是選擇 \"objective\" 來學習如何解決這個關卡",
    "es_AR": "Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elegí entre \"help level\" para aprender algo más sobre esta lección, \"help general\" para ayuda sobre el uso de Learn jj Branching, o \"objective\" para aprender a resolver este nivel.",
    "es_MX": "Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elige entre \"help level\" para aprender algo más sobre ésta lección, \"help general\" para ayuda sobre el uso de Learn jj Branching, o \"bjective\" para aprender a resolver este nivel.",
    "es_ES": "Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elige \"help level\" para aprender más sobre esta lección, \"help general\" para ayuda sobre el uso de Learn jj Branching, o \"objective\" para aprender a resolver este nivel.",
    "pt_BR": "Você está em um nível, então há vários tipos de ajuda. Selecione \"help level\" para aprender mais sobre esta lição, \"help general\" para aprender a usar o Learn jj Branching, ou \"objective\" ver como resolver o nível.",
    "gl": "Estás nun nivel, entón hai varios tipos de axuda. Selecione \"help level\" para aprender máis sobre esta lección, \"gelp general\" para aprender a usar o Learn jj Branching, ou \"objective\" para ver como resolver o nivel.",
    "fr_FR": "Vous êtes dans un niveau, donc plusieurs formes d'aide sont disponibles. Merci de sélectionner soit \"help level\" pour en apprendre plus sur cette leçon, \"help general\" pour l'utilisation de Learn jj Branching, ou \"objective\" pour apprendre comment résoudre le niveau",
    "ro": "Te afli într-un nivel, deci mai multe forme de ajutor sunt disponibile. Te rog să alegi fie \"help level\" pentru a învăța mai multe despre această lecție, \"help general\" pentru a învăța cum să folosești Learn jj Branching, sau \"objective\" pentru a învăța cum să rezolvi acest nivel.",
    ...
    "uk": "При проходженні рівня доступні декілька різновидів допомоги. Виберіть або \"help level\" щоб взнати більше про цей рівень, чи \"help general\" щоб взнати більше про Learn jj Branching, чи \"objective\" щоб дізнатись більше про проходження цього рівня",
    "ko": "현재 레벨에서, 여러가지 도움말을 참고할 수 있습니다. 레슨에 대해 자세히 알아보려면 \"help level\", LearnJjBranching을 사용하려면 \"help general\", 레벨 해결 방법에 대해 알아보려면 \"objective\"를 선택하세요.",
    ...
    "it_IT": "Sei dentro a un livello, hai a disposizione vari tipi di aiuto. Digita \"help level\" per saperne di più su questa lezione, \"help general\" per come usare Learn jj Branching, o \"objective\" per capire come risolvere il livello.",
    "ta_IN": "நீங்கள் ஒரு நிலையில் உள்ளீர்கள், எனவே பல வகையான உதவி பெற இயலும். இந்த பாடத்தைப் பற்றி மேலும் அறிய \"நிலைக்கான உதவி\" என்பதைத் தேர்ந்தெடுக்கவும், Learn jj Branching பற்றி மேலும் அறிய \"பொது உதவி\" பயன்படுத்துக, அல்லது இந்த நிலையை எவ்வாறு தீர்ப்பது என்பது பற்றி அறிய \"நோக்கம்\" தேர்ந்தெடுக்கவும்.",
    "tr_TR": "Bir seviyedesiniz, bu nedenle birden fazla yardım seçeneği mevcuttur. Bu derse dair daha fazla bilgi almak için \"help level\", Learn jj Branching kullanımını öğrenmek için \"help general\" veya seviyeyi nasıl çözeceğiniz hakkında bilgi almak için \"objective\" seçeneğini belirleyebilirsiniz."
  },
  "help-vague-builder": {
    ...
    "es_AR": "Estás en el constructor de niveles, por lo que hay varios tipos de ayuda. Elegí entre \"help general\" para ayuda sobre Learn jj Branching y \"help builder\" para ayuda sobre el constructor de niveles",
    "es_MX": "Estás en el constructor de niveles, por lo que hay varios tipos de ayuda. Elige \"help general\" para ayuda sobre Learn jj Branching y \"help builder\" para ayuda sobre el constructor de niveles",
    "es_ES": "Estás en un constructor de niveles, por lo que hay varios tipos de ayuda. Elige \"help general\" para ayuda sobre Learn jj Branching o \"help builder\" para ayuda sobre el constructor de niveles",
    ...
    "ro": "Ești într-un constructor de nivel, deci mai multe forme de ajutor sunt disponibile. Te rog să alegi fie \"help general\" pentru a învăța cum să folosești Learn jj Branching, fie \"help builder\" pentru a învăța cum să folosești constructorul de nivel.",
  ...
  "git-demonstration-title": {
    ...
    "en_US": "jj Demonstration",
    "de_DE": "jj Demonstration",
    "zh_TW": "jj 示範",
    "zh_CN": "jj 示范",
    "es_ES": "Demostración de jj",
    "es_MX": "Demostración de jj",
    "fr_FR": "Démonstration de jj",
    "gl": "Demostración de jj",
    "ro": "Demonstrație jj",
    "ru_RU": "jj демо",
    "uk": "jj демо",
    "ko": "jj 데모",
    "vi": "Trình diễn jj",
    "sl_SI": "jj Predstavitev",
    "pl": "Demo jj",
    "pt_BR": "Demonstração jj",
    "it_IT": "Dimostrazione jj",
    "ta_IN": "jj செயல் விளக்கம்",
    "tr_TR": "jj Gösterimi"
  },
  "goal-to-reach": {
