  ...
  'de_DE': [{
    ...
    options: {
      markdowns: [
        ...
        'So funktioniert\'s:',
        '',
        '  * Stelle mit jj-Befehlen die Ausgangssituation her',
        '  * Leg den Startpunkt mit ```define start``` fest',
        '  * Gib eine Abfolge von jj-Befehlen ein, welche die (optimale) Lösung darstellen',
  ...
  'es_AR': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '  * Prepará el entorno inicial usando comandos de jj',
  ...
  'es_MX': [{
    ...
    options: {
      markdowns: [
        ...
        'Estos son los pasos principales:',
        '',
        '  * Preparar el entorno inicial usando comandos de jj',
  ...
  'es_ES': [{
    ...
    options: {
      markdowns: [
        ...
        'Estos son los pasos principales:',
        '',
        '  * Prepara el entorno inicial usando comandos de jj',
  ...
  'pt_BR': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '  * Prepare o ambiente inicial usando comandos do jj',
  ...
  'gl': [{
    ...
    options: {
      markdowns: [
        ...
        '',
        '  * Prepara o eido inicial usando comandos de jj',
  ...
  'tr_TR': [{
    ...
    options: {
      markdowns: [
        ...
        'İşte ana adımlar:',
        '',
        '  * jj komutlarıyla başlangıç ortamını ayarlayın',
